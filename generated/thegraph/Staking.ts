...
export class Staking extends ethereum.SmartContract {
  ...
  getAllocation(
    ...
    return changetype<Staking__getAllocationResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getAllocation(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Staking__getAllocationResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  getDelegation(
    ...
    return changetype<Staking__getDelegationResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getDelegation(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Staking__getDelegationResultValue0Struct>(value[0].toTuple())
    );
  }
